            ...
            <div class="table-title">
              <div class="row">
                ...
                $req2 = "SELECT d.id_demande AS id, m.nom_membre AS nom, m.prenom_membre AS prenom, d.deadline AS date, m.type_sang AS tsang from demande d, membre m where 
                  d.id_membre=m.id_membre and d.id_centre='$idc'";
        ...
        <div class=" mb-4">
          <div class="card mb-3" style="border-radius: .5rem;">
            ...
            <div class="title px-5 pt-5 ">
              <h1 class="text-center mb-3">Êtes-vous sûr de vouloir supprimer cette demande du sang ? </h1>
            ...
            <div class="row mb-5">
              <div class="row ">
                <div class="col-sm-6 d-flex justify-content-center">
                  <button class="btn btn-primary" onclick="ShowMessageDelete()">Annuler</a>
                </div>
                <div class="col-sm-6 ">
                  <button class="btn btn-primary">Supprimer</a>
                </div>
              </div>
            </div>
          </div>
