    ...
    if (isset($_POST['btn'])) {
        ...
        ';
                ...
                try {
                    ...
                    // Send the email
                    $mail->send();
                    $notif = "Admin a invité  $email à être votre médecin. ";
                    $req_notif = "insert into notification (notif_name, notif_message, active, id_centre) values('Invitation d\'un médecin', '$notif', 1,$id)";
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-sm-6 mb-4 search d-flex align-items-center justify-content-between">
                                            ...
                                            <select name="centre" class="form-control"
                                                style="width: max-content; height: 42px;" required>
                                                ...
                                                while ($rowcentre = $rescentre->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    <option value="<?= $rowcentre['id_centre'] ?>"><?= $rowcentre['nom_centre'] ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        </div>
