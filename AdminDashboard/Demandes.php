            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <button class="btn add">
                  <a href="ajoutDemande.php" class=" text-decoration-none">Ajouter Demande</a>
                </button>
              </div>
              <?php
              // had 2 req katijib num ela wed num row dyl search
              $req2 = "SELECT d.id_demande AS id, c.ville_centre, d.type_sang,m.nom_membre AS nom, m.prenom_membre AS prenom, d.deadline AS date, m.type_sang AS tsang, m.ville as ville, m.cin_membre AS cin
                       FROM demande d
                       INNER JOIN membre m ON d.id_membre = m.id_membre
                       INNER JOIN centre c ON d.id_centre = c.id_centre";
              $req = "SELECT d.id_demande AS id, c.ville_centre, d.type_sang,m.nom_membre AS nom, m.prenom_membre AS prenom, d.deadline AS date, m.type_sang AS tsang, m.ville as ville, m.cin_membre AS cin
                       FROM demande d
                       INNER JOIN membre m ON d.id_membre = m.id_membre
                       INNER JOIN centre c ON d.id_centre = c.id_centre";
              $search = '';
              ...
              <tr class="searchs">
                ...
                <th class="search">
                  ...
                  if (isset($_GET['search-sang'])) {
                    ...
                    if ($search_sang != 'Tous') {
                      $req .= " and (m.type_sang like '%$search_sang%' or d.type_sang like '%$search_sang%' )";
                      $req2 .= " and (m.type_sang like '%$search_sang%' or d.type_sang like '%$search_sang%' )";
                    }
                  }
                  ?>
                ...
                <th class="search">
                  ...
                  if (isset($_GET['search-ville'])) {
                    ...
                    if ($search_ville != 'Tous') {
                      $req .= " and (m.ville like '%$search_ville%' or c.ville_centre like '%$search_ville%' )";
                      $req2 .= " and ( m.ville like '%$search_ville%' or c.ville_centre like '%$search_ville%' )";
                    }
                  }
                ...
                foreach ($row as $data) {
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-around align-items-center">
                      ...
                      <a href="operations_demande.php?action=Edit&id=<?=$data['id']?>" class="edit" title="Edit" data-toggle="tooltip"><i class="fa-solid fa-pen-to-square"></i></a>
                      <a href="operations_demande.php?action=Delete&id=<?=$data['id']?>" class="delete" title="Delete" data-toggle="tooltip"><i class="fa-solid fa-trash"></i></a>
                    </td>
                  </tr>
