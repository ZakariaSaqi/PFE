              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                            <button class="btn add">
                             <a href="ajouterdon.php" class=" text-decoration-none">Ajouter Don</a>
                            </button>
                          </div>
                <?php
                // had 2 req katijib num ela wed num row dyl search
                $req2 = "SELECT d.id_don as id,  m.nom_membre AS nom, m.prenom_membre AS prenom, m.type_sang AS sang, d.date_don AS date
                -- , md.nom_medecin AS nommdecin, md.prenom_medecin AS premdecin
                FROM membre m
                INNER JOIN don d ON d.id_membre = m.id_membre
                INNER JOIN medecin md ON d.id_centre = md.id_medecin
                INNER JOIN demande dem ON d.id_demande = dem.id_demande
                WHERE d.id_medecin = $idm" ;
                $req = "SELECT d.id_don as id,  m.nom_membre AS nom, m.prenom_membre AS prenom, m.type_sang AS sang, d.date_don AS date
                -- , md.nom_medecin AS nommdecin, md.prenom_medecin AS premdecin
                FROM membre m
                INNER JOIN don d ON d.id_membre = m.id_membre
                INNER JOIN medecin md ON d.id_centre = md.id_medecin
                ...
                if (isset($_GET['search-btn'])) {
                  ...
                  $req2 .= " and  (m.nom_membre like '%$search%' OR m.prenom_membre like '%$search%' OR d.id_don like '$search')";
                  
                  $req .= " and  (m.nom_membre like '%$search%' OR m.prenom_membre like '%$search%' OR d.id_don like '$search')";
      ...
      <div class="row d-flex justify-content-center align-items-center">
        <div class="col-lg-8 mb-4 mb-lg-0">
          ...
          <div class="x-mark pt-2 px-2">
            ...
            <div class="row g-0">
              <div class="col-md-4 px-3 bg text-center text-white d-flex flex-column justify-content-center align-items-center"
