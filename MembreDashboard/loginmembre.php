...
if (isset($_POST['btnok'])) {
    ...
    $password = $_POST['psw'];
    $req = "SELECT * FROM membre WHERE login='$login' && password='$password'";
    $res = $pdo->query($req);
    $count = $res->rowCount();
...
<body>
    <section class="d-flex align-items-center justify-content-between" style="height: 95vh;">
        <div class="signup-form">
            ...
            <div class="text-center">Vous n'avez pas de compte? <a href="signup.php">S'inscrire</a></div>
